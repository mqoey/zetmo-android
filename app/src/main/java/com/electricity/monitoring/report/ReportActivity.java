...
public class ReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appliance_report);
        ...
        dbHandler = new DBHandler(ReportActivity.this);
        ...
        if (applianceTimeArrayList.isEmpty()) {
            ...
            reportAdapter = new ReportAdapter(ReportActivity.this, applianceTimeArrayList);
