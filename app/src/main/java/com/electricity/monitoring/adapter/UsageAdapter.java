...
public class UsageAdapter extends RecyclerView.Adapter<UsageAdapter.MyViewHolder> {
    ...
    public UsageAdapter(Context context, ArrayList<ApplianceTime> applianceTimeData) {
    ...
    @NonNull
    @Override
    public UsageAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.appliancetime_item, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UsageAdapter.MyViewHolder holder, int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            Intent i = new Intent(context, ViewUsageActivity.class);
